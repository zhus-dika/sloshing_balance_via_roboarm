...
#define RESET_FLAG "/home/dika/Documents/sloshing_balance_via_roboarm/glass_liquid_sloshing_simulink/vessel-res-3/reset/reset.ok"

/* ---------- геометрия и материал --------------------------------- */
#define ZONE_VESSEL_LIQ  16     /* id зоны внутри сосуда */
