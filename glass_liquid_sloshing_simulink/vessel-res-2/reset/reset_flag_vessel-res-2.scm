...
(define (reset-if-flag)
  (let* ((flag    "/home/dika/Documents/sloshing_balance_via_roboarm/glass_liquid_sloshing_simulink/vessel-res-2/reset/reset.ok")
    ...
    (if (file-exists? flag)
        ...
        (begin
          ...
          (if (remove-file flag)
              ...
              (format #t "Warning: can't delete reset.ok~%")))
